...
public class TabDisplay extends ActionBarActivity implements
	...
	public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if(id == R.id.menu_item_share)
        {
            ...
            String shareBody = "Hey! there try this awesome app.\nIt contains schedule for buses running from Durg to Raipur\nhttps://play.google.com/store/apps/details?id=com.nadeem.cgbus";
	...
	public static class PlaceholderFragment extends ListFragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			BusArrayAdapter adapter = new BusArrayAdapter(getActivity().getBaseContext(), R.layout.list_item_star, values, day, allowFavorites,selectedBus, selectedDirection);
	...
	public void checkboxClicked(View v) {
		...
		if(checkBox.isChecked()){
            ...
            //CommonUtilities.getIcon(CommonUtilities.ICONS.NOT_FAVORITE));
		}
	}
